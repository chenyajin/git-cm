  ...
  return {
    'en-US': {
      descriptions: {
        ...
        scope: [`${_index.config.scopeRequired ? 'Required' : 'Optional'}, can be anything specifying the scope of the commit change.`, 'In App Development, scope can be a page, a module or a component.'],
